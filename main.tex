...
The expression of $n^*$ from (\ref{opt_n}) is referred to as the \textit{optimal fixed sample size} required to construct the FWCI, $J_n$, for $\mu$ had $\sigma$ been known. \\
\vspace{0.2cm}
